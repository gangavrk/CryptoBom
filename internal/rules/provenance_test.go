...
var emittedRuleIDs = []string{
	...
	"CB-WEAK-KEYSIZE", "CB-WEAK-CURVE", "CB-WEAK-CERT-SIG", "CB-WEAK-MAC", "CB-CERT-EXPIRED",
	"CB-MISUSE-ECB", "CB-MISUSE-STATIC-IV", "CB-MISUSE-HARDCODED-KEY",
	"CB-MISUSE-WEAK-PRNG", "CB-MISUSE-TIMING-COMPARE", "CB-MISUSE-RSA-PKCS1V15",
	...
	"CB-INV-RANDOM", "CB-INV-CIPHER", "CB-INV-MAC", "CB-INV-KDF",
}
